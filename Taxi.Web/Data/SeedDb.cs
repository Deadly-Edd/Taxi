...
namespace Taxi.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Eduardo", "Fuentes", "efuenteszeledon@gmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.Admin, "Zulu.jpg");
        ...
        private List<Photo> LoadPhotos()
        {
            return new List<Photo>
            {
                ...
                new Photo { Firstname = "Jhon", Lastname = "Smith", Image = "Jhon.png" },
                ...
                new Photo { Firstname = "Manuela", Lastname = "Ateortua", Image = "Manuela.jpeg" },
